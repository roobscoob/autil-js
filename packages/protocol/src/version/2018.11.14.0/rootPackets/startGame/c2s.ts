...
import { StartGameC2S } from "../../../abstract/rootPackets/startGame";
import { GameCode_V2018_11_14_0 } from "../../types/gameCode";
import { RootPacketTags_V2018_11_14_0 } from "../../tags";

export class StartGameC2S_V2018_11_14_0 extends StartGameC2S {
  static fromAbstract(data: StartGameC2S) {
    return new StartGameC2S_V2018_11_14_0(
  ...
  static deserialize(reader: BinaryReader): StartGameC2S_V2018_11_14_0 {
    return new StartGameC2S_V2018_11_14_0(
  ...
  serialize(): MessageWriter {
    const writer = MessageWriter.allocateTagged(RootPacketTags_V2018_11_14_0.StartGame, 4);
