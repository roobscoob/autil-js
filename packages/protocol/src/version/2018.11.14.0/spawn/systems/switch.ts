...
import { SpawnSwitchSystem } from "../../../abstract/spawn/systems/switch";
import { Switches_V2018_11_14_0 } from "../../types/switch";

export class SpawnSwitchSystem_V2018_11_14_0 extends SpawnSwitchSystem {
  static fromAbstract(data: SpawnSwitchSystem) {
    return new SpawnSwitchSystem_V2018_11_14_0(
